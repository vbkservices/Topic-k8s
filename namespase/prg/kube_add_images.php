...
if($enapikey == "2727175#356"){
        shell_exec('sudo kubectl label namespace '.$namepase.' docker.'.$images_name.'='.$images_name.'');
        shell_exec('echo "sudo kubectl label namespace '.$namepase.' docker.'.$images_name.'='.$images_name.'">/shell/error.log');
}
?>