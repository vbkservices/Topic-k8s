...
window.onload=function(){
    document.querySelector('#images_user').innerHTML =`<a href="http://120.114.142.17/sys/namespase/namespase_create.html"
...
function images_dropdown_status(namepase) {
    ...
    function showValue(e) {
      ...
      <div class="spinner-grow text-dark" role="status">
        ...
        $.ajax({ //kubectll get pods
            type: "post",
            url: 'http://120.114.142.17/sys/namespase/prg/kube_add_images.php',
            //dataType: "json",
            data: fddjs,
            processData: false,
            //將原本不是xml時會自動將所發送的data轉成字串(String)的功能關掉
...
function status_pod(namepase) {
    ...
    window.location = "http://120.114.142.17/sys//namespase/namespase_container.html"
    /*
    let fdelete = new FormData();
    fdelete.append('apikey', 'kqzt+7MNF0nJFf+3uB8tRw==');
    fdelete.append('namepase', namepase);
