...
function gottycreate(student,port,container,namespace) {
    ...
    $.ajax({ //kubectll get pods
        type: "post",
        url: 'http://120.114.142.17/sys/webtty/prg/kube_gotty_create.php',
        // dataType: "json",
        data: fddyaml,
        processData: false,
        //將原本不是xml時會自動將所發送的data轉成字串(String)的功能關掉
...
function gottyclose(student) {
    ...
    $.ajax({ //kubectll get pods
        type: "post",
        url: 'http://120.114.142.17/sys/webtty/prg/kube_gotty_close.php',
        // dataType: "json",
        data: fddyaml,
        processData: false,
        //將原本不是xml時會自動將所發送的data轉成字串(String)的功能關掉
...
function linkon(students) {
    ...
    $.ajax({ //kubectll get pods
        type: "post",
        url: 'http://120.114.142.17/sys/webtty/prg/kube_gotty_pts_create.php',
        // dataType: "json",
        data: fddyaml,
        processData: false,
        //將原本不是xml時會自動將所發送的data轉成字串(String)的功能關掉
